...
QIcon QgsFields::iconForField( int fieldIdx ) const
{
  ...
  {
    case QVariant::Bool:
      return QgsResources::getThemeIcon( "/mIconFieldBool.svg" );
    ...
    {
      return QgsResources::getThemeIcon( "/mIconFieldInteger.svg" );
    }
    case QVariant::Double:
    {
      return QgsResources::getThemeIcon( "/mIconFieldFloat.svg" );
    }
    case QVariant::String:
    {
      return QgsResources::getThemeIcon( "/mIconFieldText.svg" );
    }
    case QVariant::Date:
    {
      return QgsResources::getThemeIcon( "/mIconFieldDate.svg" );
    }
    case QVariant::DateTime:
    {
      return QgsResources::getThemeIcon( "/mIconFieldDateTime.svg" );
    }
    case QVariant::Time:
    {
      return QgsResources::getThemeIcon( "/mIconFieldTime.svg" );
    }
    case QVariant::ByteArray:
    {
      return QgsResources::getThemeIcon( "/mIconFieldBinary.svg" );
    }
    default:
      return QIcon();
  }
