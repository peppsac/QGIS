...
class QgsExtractVerticesAlgorithm : public QgsProcessingAlgorithm
{
  ...
  public:
    ...
    QIcon icon() const override { return QgsResources::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmExtractVertices.svg" ) ); }
    QString svgIconPath() const override { return QgsResources::iconPath( QStringLiteral( "/algorithms/mAlgorithmExtractVertices.svg" ) ); }
