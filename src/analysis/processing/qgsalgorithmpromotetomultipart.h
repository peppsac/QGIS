...
class QgsPromoteToMultipartAlgorithm : public QgsProcessingFeatureBasedAlgorithm
{
  ...
  public:
    ...
    QIcon icon() const override { return QgsResources::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmSingleToMulti.svg" ) ); }
    QString svgIconPath() const override { return QgsResources::iconPath( QStringLiteral( "/algorithms/mAlgorithmSingleToMulti.svg" ) ); }
