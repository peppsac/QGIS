...
class QgsMergeVectorAlgorithm : public QgsProcessingAlgorithm
{
  ...
  public:
    ...
    QIcon icon() const override { return QgsResources::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmMergeLayers.svg" ) ); }
    QString svgIconPath() const override { return QgsResources::iconPath( QStringLiteral( "/algorithms/mAlgorithmMergeLayers.svg" ) ); }
